...
import OrderTrackingModal from "./features/products/orders/OrderTrackingModal";
import InvoiceModal from "./features/products/orders/InvoiceModal";
  ...
  return (
    <div dir="rtl" className="app">
      ...
      <OrderTrackingModal
        ...
        myOrdersSearched={myOrdersSearched}
        setMyOrdersSearched={setMyOrdersSearched}
        onSendOtp={sendOtp}
        onVerifyOtp={verifyOtpAndFetch}
      ...
      <InvoiceModal
        ...
        storeName={settings?.store_name || "NOVA SHOP"}
        onPrint={printCustomerInvoice}
      />
